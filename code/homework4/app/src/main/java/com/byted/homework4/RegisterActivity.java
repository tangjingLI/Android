                ...
                apiService.register(name,password,repassword).enqueue(new Callback<UserResponse>() {
                    ...
                    public void onResponse(Call<UserResponse> call,
                        ...
                        if (response.body()!=null&&response.body().user!=null){
                            Toast.makeText(RegisterActivity.this,"注册成功！"+"欢迎"+response.body().user.nickname,Toast.LENGTH_SHORT).show();
                        }
                        else{
                    ...
                    public void onFailure(Call<UserResponse> call, Throwable t) {
                        Toast.makeText(RegisterActivity.this,"网络故障，请稍后再试",Toast.LENGTH_SHORT).show();
