...
public class CustomClockView extends View {
    ...
    private void drawClockPoint(Canvas canvas) {
        ...
        canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 160, mPaint);//时针长度设置为65

        canvas.restore();
        canvas.save();
        canvas.rotate(minAngle,getWidth() / 2, getHeight() / 2);
        canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 200 , mPaint);//分针长度设置为90

        canvas.restore();
        canvas.save();
        canvas.rotate(secAngle,getWidth() / 2, getHeight() / 2);
        canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 280 , mPaint);//秒针长度设置为110
    ...
    private void initPaint() {
        mPaint.reset();
        mPaint.setColor(Color.rgb(133,177,211));
